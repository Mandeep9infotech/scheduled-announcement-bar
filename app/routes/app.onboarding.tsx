...
export default function Onboarding() {
  ...
  return (
    <div style={{ fontFamily: "sans-serif", maxWidth: "600px", margin: "60px auto", padding: "40px", background: "#fff", borderRadius: "12px", boxShadow: "0 2px 12px rgba(0,0,0,0.1)" }}>
      ...
      <div>
        ...
        <p>Come back here to create and schedule your announcements!</p>
          ...
          href="/app"
          style={{ display: "inline-block", background: "#f0f0f0", color: "#333", padding: "10px 20px", borderRadius: "8px", textDecoration: "none" }}
        >
          Go to Dashboard
        </a>
      </div>
